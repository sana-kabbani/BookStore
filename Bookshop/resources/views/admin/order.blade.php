            ...
            <div class="content-wrapper">
                ...
                <table class="table_deg">
                    <tr class="th_deg">
                        ...
                        <th style="padding: 10px"> Kargo Durumu </th>

                        <th style="padding: 10px"> Photo </th>
                        <th style="padding: 10px"> Teslim Edildi </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <a  class="btn btn-primary"  href="{{ url('/delivered ' ,$order->id) }}" >Teslim Edildi</a>
                         </td>
